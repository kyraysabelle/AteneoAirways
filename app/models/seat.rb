class Seat < ApplicationRecord
	...
	private 
		...
		def check_baggage
			...
			if @total_baggage + baggage > @flight.baggage_allowance then
					errors.add(:baggage, "Exceeds weight allowance by " + (-1 * (@flight.baggage_allowance - @total_baggage - baggage)).to_s)
